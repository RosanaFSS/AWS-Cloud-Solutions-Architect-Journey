...
<p><ol type="1. ">
    <li><a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-policy-simple.html">Simple routing policy</a> : route traffic to a single resource, for example, to a web server for your website. You can use simple routing policy for records in a private hosted zone.</li>
